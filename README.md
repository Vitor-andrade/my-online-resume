...
This repository hosts the source of an **online professional résumé** for **Vitor Cavalcante**, a Senior Fullstack Engineer with 6+ years of experience. It is deliberately more than a CV page: it is a **technical showcase**. The intent is that a recruiter or engineering lead can read the résumé *and* inspect the repository, and both tell the same story — modern, scalable, accessible, secure engineering.
